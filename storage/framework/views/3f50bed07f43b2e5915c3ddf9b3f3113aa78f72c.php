                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6 col-md-12 col-xs-12 buscar">
                        ...
                        <?php if( Auth::user()->role_id !== 1 ): ?>
                            <input type="text" id="buscar" name="buscar" class="form-control" placeholder="Buscar" value="<?php echo e(Auth::user()->name); ?>" disabled="disabled">
                            <input type="hidden" id="cliente_id" name="cliente_id" value="<?php echo e(Auth::user()->id); ?>"/>
